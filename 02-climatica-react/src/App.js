...
export default class App extends Component {
    ...
    getClimaAtualPorPosicao = (lat, lon) => {
        axios
            .get(`http://api.openweathermap.org/data/2.5/weather?APPID=e26ac13ac93e35d3f18a0fe899791d93&lat=${lat}&lon=${lon}&units=metric&lang=pt`)
            .then(response => {
    ...
    getClimaAtualPorCidade = (cidade) => {
        ...
        axios
            .get(`http://api.openweathermap.org/data/2.5/weather?APPID=e26ac13ac93e35d3f18a0fe899791d93&lang=pt&units=metric&q=${encodeURI(cidade)},BR`)
            .then(response => {
                this.setState({ ...this.state, climaAtual: response.data });
            });
    }
